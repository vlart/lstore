...
@section('content')
    ...
    <section class="checkout-section">
        <div class="checkout">
            ...
            <div>
                <div class="w-form">
                    <form class="ch-form" action="{{route('checkout')}}" method="post" data-name="checkout" id="checkout-form" name="checkout-form">
                        ...
                        <div class="ch-item-group">
                            <input class="ch-input-split right w-input" data-name="CVV Field" id="CVV-Field" maxlength="3" name="CVV-Field" placeholder="CVV" required="required" type="text">

                            <input class="ch-input-split mid-year w-input" data-name="Expiration Date Field" id="Exp-year" maxlength="2" name="Exp-year" placeholder="YY" required="required" type="text">
                            ...
                            <label class="ch-label" for="CVV-Field">Card CVV:</label>
